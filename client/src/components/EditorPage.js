...
function EditorPage() {
  ...
  const toggleChatbotWindow = () =>{
    setIsChatbotWindowOpen(!isChatbotWindowOpen);
  }
  ...
  return (
    <div className="container-fluid vh-100 d-flex flex-column">
      <div className="row flex-grow-1">
        ...
        <div className="col-md-10 text-light d-flex flex-column">
          ...
          <div className="bg-dark p-2 d-flex justify-content-end">
            ...
            <button
              className="btn btn-primary position-fized m-2"
              onClick={toggleChatbotWindow}
              
            >
              {isCompileWindowOpen ? "Close Chatbot" : "Open Chatbot"}
            </button>
          </div>
      ...
      {isChatbotWindowOpen && (
        <div className="position-fixed top-0 end-0 h-100 bg-light p-3 shadow-lg bg-dark" style={{ width: "400px", zIndex: 1050 }}>
          <button className="btn btn-danger w-100 mb-3" onClick={toggleChatbotWindow}>Close Chatbot</button>
